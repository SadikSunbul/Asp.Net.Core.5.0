...
namespace ders3.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var tuple = (new Product(), new User()); //null olmaması ıcın yaptık 
            return View(tuple);
        }
        [HttpPost]
        public IActionResult Create([Bind(Prefix = "Item1")]Product product, [Bind(Prefix = "Item2")] User user) //burada ıtem ıle verılmelı dıger tarafta ıstedıgın kadar ezmıs  ol burada ıselmez
        {
            return View();
        }
        #endregion
